...
@Composable
fun LeaderBoardExerciseCard (index: Int?, nombre: String?, cantidad: Int?){
    Row(
        ...
        Column {
            ...
            Text("Sets completados: ${cantidad.toString()}     ", fontSize = 14.sp, color = Color.Gray)
        }
    }
}
...
@Composable
fun LeaderBoardExercisePreview(){
    Card(
